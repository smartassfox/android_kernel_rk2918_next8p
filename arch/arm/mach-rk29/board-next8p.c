...
#define PMEM_SKYPE_SIZE     SZ_8M //SZ_8M /* 0*/
#define PMEM_CAM_SIZE       0x01300000 /* PMEM_CAM_NECESSARY */
#ifdef CONFIG_VIDEO_RK29_WORK_IPP
#define MEM_CAMIPP_SIZE     SZ_4M //SZ_8M /* PMEM_CAMIPP_NECESSARY */
#else
#define MEM_CAMIPP_SIZE     0
#endif
#define MEM_FB_SIZE         (3*SZ_2M) /* (9*SZ_1M) */
...
//  .orientation = { 0, 1, 0, 1, 0, 0, 0, 0, 1}, //Workaround for NEXT8P by marxo
};
#endif
...
struct rk2818_gs_platform_data rk2818_gs_platdata = {
	.gsensor_irq_pin = MMA8452_INT_PIN,
	.swap_xy 	   = 0,
};
#endif
