...
#define GPIO_WIFI_POWER       RK29_PIN6_PC0   // Added by Yatto for M810C
...
// Yatto	POWER_USE_GPIO, POWER_GPIO_IOMUX, 
// Yatto	GPIO5D6_SDMMC1PWREN_NAME, GPIO5H_GPIO5D6, GPIO_WIFI_POWER, GPIO_HIGH 
...
#if defined(CONFIG_MACH_RK29_ODYS_NEOX7)
