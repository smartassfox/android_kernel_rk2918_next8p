...
const struct linux_logo * __init_refok fb_find_logo(int depth)
{
	...
	if (depth >= 8) {
		...
		/* Generic Linux logo */
		logo = &logo_N90_clut224;
#endif
#ifdef CONFIG_LOGO_G3_CLUT224
		/* Generic Linux logo */
		logo = &logo_g3_clut224;
#endif
#ifdef CONFIG_LOGO_OEM_CLUT224
		logo = &logo_oem_clut224;
#endif
#ifdef CONFIG_LOGO_MONDOROID_CLUT224
	/* Mondoroid logo */
	logo = &logo_mondoroid_clut224;
#endif
#ifdef CONFIG_LOGO_NEOX8_CLUT224
        /* Odys NEOX8 logo */
        logo = &logo_neox8_clut224;
#endif
#ifdef CONFIG_LOGO_NEOX7_CLUT224
        /* Odys NEOX7 logo */
        logo = &logo_neox7_clut224;
#endif
#ifdef CONFIG_LOGO_Q_CLUT224
        /* Odys NEOX8 logo */
        logo = &logo_q_clut224;
#endif
#ifdef CONFIG_LOGO_KEPLER2_CLUT224
        /* BQ Kepler2 logo */
        logo = &logo_kepler2_clut224;
#endif
#ifdef CONFIG_LOGO_PASCAL2_CLUT224
        /* BQ Pascal2 logo */
