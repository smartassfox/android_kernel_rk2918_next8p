...
#else
#if defined (CONFIG_MACH_M803) || defined (CONFIG_MACH_RK29_ODYS_NEOX8) || defined (CONFIG_MACH_M803HD) || defined (CONFIG_MACH_RK29_NEXT8P) //battery: AE4169100P6HAS: 6000mAH
